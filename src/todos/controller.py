...
def create_todo(todo: model.TodoCreate, current_user: CurrentUser, db: DBSession):
...
def update_todo(todo_id: UUID, todo_update: model.TodoCreate, current_user: CurrentUser, db: DBSession):
